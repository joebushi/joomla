	...
	initialize: function()
	{
		...
		this.tree = new MooTreeControl(
			...
			},
			{
				...
				open: true,
				data: {
					url: 'index.php?option=com_media&view=folder&tmpl=component&folder=/',
					target: 'folderframe'
				}
			});
...
return;
	...
	setViewType: function(type)
	{
		...
		viewstyle = type;
		var folder = this.getFolder();
		this._setFrameUrl('index.php?option=com_media&view=folder&tmpl=component&folder='+folder+'&layout='+type);
	},
