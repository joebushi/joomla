<?php
/**
* @version $Id: libraries.php,v 1.1 2005/08/26 17:00:22 pasamio Exp $
* @package Mambo Update Systems
...
* @subpackage Libraries
*/
class mosLibraryInstaller extends mosInstaller {
	/** @var string The element type */
	var $elementType = 'library';
	/** @var int */
	var $mambotId = null;
	/** @var string */
	var $_botGroup = null;
	...
	function getBasePath( $client=0 ) {
		...
		return mosFS::getNativePath( $mosConfig_absolute_path . '/libraries' );
	}
