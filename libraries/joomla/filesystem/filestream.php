<?php
/**
 * @version		$Id: file.php 10938 2008-09-16 08:04:06Z pasamio $
...
/**
 * A File handling class using streams
 *
 * @static
 ...
 * @since		1.5
 */
class JFileStream extends JFile
{
	/**
	 * Copies a file
	 *
	...
	function copy($src, $dest, $path = null)
	{
		...
		//Check src path
		if (!is_readable($src)) {
			JError::raiseWarning(21, 'JFileStream::copy: '.JText::_('Cannot find or read file' . ": '$src'"));
			return false;
		}
