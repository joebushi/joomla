...
jimport( 'joomla.database.datacontainerconnector' );
jimport( 'joomla.database.recordset' );

/**
 * Generic connector for all datbase driven containers
 *
 * @abstract
 ...
 * @since		1.1
 */
class JDatasbaseConnector extends JDatacontainerConnector 
{
