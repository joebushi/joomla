...
class JDatabaseMySQL extends JDatabase
{
	...
	/**
	 * MySQL database driver object constructor.
	 *
	 * @see		JDatabase
	 * @throws	JException
	...
	protected function __construct($options)
	{
		...
		// Make sure the PHP extension for MySQL exists and is enabled.
		if (!function_exists('mysql_connect')) {
			throw new JException('The MySQL adapter "mysql" is not available.', 1);
		}
	...
	/**
	 * MySQL database driver object destructor.  Tidy up any residual
	...
	/**
	 * Test to see if the MySQL driver is available.
	 *
	...
	public function query()
	{
		...
		if (!$this->_cursor) {
			...
			throw new JException(mysql_error($this->_resource), mysql_errno($this->_resource), $level, $sql);
		}
