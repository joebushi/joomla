<?php
/**
* @version $Id: TODO.php,v 1.3 2005/09/01 07:13:59 facedancer Exp $
* @package Mambo
...
<b>** Preparation for 4.5.3 SoC Release (1st September, 2005) **</b>

<hr/>
<span class="todotitle">MUST FIX BEFORE ALPHA</span>

- {mospagebreak} mambot not working correctly: repeats text

- Global configuration under reconstruction
  * need to remove the 'tabs'
...
- <s>Media Manager
  ...
  * File upload
  * Display Icon of non-image files</s>
...
- Media Manager
  * <s>Tree</s>
  * <s>Handle general 'docs' type of file</s>
  * <s>Add configuration interface to allow settings to be stored
	in the 'params' fields of the components table
	- add com_media to the table iscore=1
	- Don't just add configuration variables to configuration.php</s>
  * <s>Configuraton setting for allowed image and file types</s>
  * Test folder delete
  * <s>Test a variation of list_icons.html to shows details list
	(list_details.html) and add list style selection</s>
  * Change trash can to checkbox and add delete icon
  * <s>Add 'up directory' as first folder</s>
  * <s>Add safeguard for not going above valid root directories</s>
  * <s>Add configuration variable to allow 'other' root directories,
	for example docman's /dmdocuments</s>
  [Mateusz Krzeszowiec :: Mambo-Google SOC]
