...
class JHTMLIcon
{
	...
	{
		$url = 'index.php?option=com_contenttask=article.add&return='.base64_encode(JFactory::getURI()).'&id=0&sectionid='.$article->sectionid;
	...
	static function edit($article, $params, $attribs = array())
	{
		...
		$url = 'index.php?task=article.edit&id='.$article->id.'&return='.base64_encode(JFactory::getURI());
