	...
	<?php if ($this->params->get('image') || $this->params->get('description')) : ?>
		<div class="contentdescription<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
			<?php if ($this->params->get('show_image')) : ?>
				<img src="<?php echo $this->baseurl .'/'. $this->cparams->get('image_path') . '/'. $this->params->get('image'); ?>" align="<?php echo $this->params->get('image_align'); ?>" hspace="6" alt="<?php echo JText::_( 'Description Image' ); ?>" />
			<?php endif;
