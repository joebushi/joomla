<?php
/**
* @version $Id: mambo.factory.php,v 1.1 2005/08/25 14:21:09 johanjanssens Exp $
* @package Mambo
...
class mosFactory {
	...
	*/
	...
	/**
	 * Returns singleton of a mosScriptHandler Object
	 * @package Mambo
	 * @copyright (C) 2005 Richard Allinson www.ratlaw.co.uk
	 * @license http://www.gnu.org/copyleft/gpl.html GNU/GPL
	 * Mambo is Free Software
	 *
	 * @return mosScriptHandler
	 */
	function &getScriptHandler()
	{
		$scriptHandler =& mosSingleton::getInstance('mosScriptHandler', 'mosFactory::_createScriptHandler');
		return $scriptHandler;
	}
	
	/**
	 * Creates a mosScriptHandler Object
	 * @package Mambo
	 * @copyright (C) 2005 Richard Allinson www.ratlaw.co.uk
	 * @license http://www.gnu.org/copyleft/gpl.html GNU/GPL
	 * Mambo is Free Software
	 ...
	 * @return mosScriptHandler
	 */
	function &_createScriptHandler()
	{
		mosFS::load( 'includes/mambo.scripthandler.php' );
		
		$scriptHandler =& new mosScriptHandler();
		return $scriptHandler;
	}
}
?>