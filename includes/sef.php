<?php
/**
* @version $Id: sef.php,v 1.1 2005/08/25 14:21:09 johanjanssens Exp $
* @package Mambo
...
function sefRelToAbs( $string ) {
	global $mosConfig_live_site, $mosConfig_secure_site, $mosConfig_unsecure_site, $mosConfig_sef, $mosConfig_mbf_content;
	...
	//ensure that links use the proper site/secure url with protocol
