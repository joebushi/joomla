...
$PHPTHUMB_CONFIG['document_root'] =  $mosConfig_live_site;
...
//$PHPTHUMB_CONFIG['cache_directory'] = 'http://'.$_SERVER['HTTP_HOST'].'/cache/phpThumb/';                                           // set the cache directory relative to the source image - must start with '.' (will not work to cache URL- or database-sourced images, please use an absolute directory name)
//$PHPTHUMB_CONFIG['cache_directory'] = null;                                                 // disable thumbnail caching (not recommended)
$PHPTHUMB_CONFIG['cache_directory'] = $mosConfig_absolute_path.'/cache/phpThumb/';
