<?php
/**
* @version $Id: mambo.php,v 1.3 2005/09/02 18:43:47 alekandreev Exp $
* @package Mambo
...
require_once( $path . '/versioning.php' );
  ...
  /**
	...
	*/
	function getBlogSectionCount( ) {
		...
		."\n LEFT JOIN #__menu AS m ON m.componentid = s.id "
		."\n WHERE m.type = 'content_blog_section'"
		."\n AND m.published = '1' AND i.active = 1"
		;
		$this->_db->setQuery( $query );
...
* @package Mambo
*/
class mosContent extends mosDBVersionedTable {
	/** @var int Primary key */
	var $id					= null;
	/** @var string */
	var $title				= null;
