...
class ADORecordSet_mysqli extends ADORecordSet{	
	...
	function ADORecordSet_mysqli($queryID, $mode = false) 
	{
	  ...
	  switch ($mode)
	    {
	    case ADODB_FETCH_OBJECT: 
	      $this->fetchMode = ADODB_FETCH_OBJECT; 
	      break;
	...
	function MoveNext() 
	{
		...
		$this->_currentRow++;
		if ($this->fetchMode == ADODB_FETCH_OBJECT) { // Mambo
			$this->fields = @mysqli_fetch_object($this->_queryID);  
			if (is_object($this->fields)) return true;
		} else {
