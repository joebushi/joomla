<?php
/**
* @version $Id: gacl.mambo.php,v 1.1 2005/08/25 14:21:19 johanjanssens Exp $
* @package Mambo
* @subpackage phpGACL
...
class mambo_acl_api extends gacl_api {
	...
	function mambo_acl_api($options = NULL) {
		...
		// backend menus
		//$this->_mos_add_acl( 'com_config', 'manage', 'users', 'administrator', null, null );
		$this->_mos_add_acl( 'com_config', 'manage', 'users', 'super administrator', null, null );

		// access to db admin
		//$this->_mos_add_acl( 'com_dbadmin', 'manage', 'users', 'super administrator' );
		...
		$this->_mos_add_acl( 'com_newsflash', 'edit', 'users', 'manager' );
		$this->_mos_add_acl( 'com_frontpage', 'edit', 'users', 'manager' );
		$this->_mos_add_acl( 'com_media', 'edit', 'users', 'manager' );
		...
		$this->_mos_add_acl( 'com_users', 'block_user', 'users', 'administrator' );
		$this->_mos_add_acl( 'com_users', 'block_user', 'users', 'super administrator' );
