		...
		<div class="m">
				<div class="far-right">
					<?php if ($this->direction == 'ltr') : ?>
							<div class="button1-right"><div class="prev"><a onclick="submitForm(adminForm, 'mainconfig');" title="<?php echo JText::_('Previous', true) ?>"><?php echo JText::_('Previous') ?></a></div></div>
					...
					<?php else: ?>
							...
							<div class="button1-left"><div class="next"><a onclick="submitForm(adminForm, 'mainconfig');" title="<?php echo JText::_('Previous', true) ?>"><?php echo JText::_('Previous') ?></a></div></div>
					<?php endif; ?>
				</div>
