<?php // @version $Id: complete.php 11845 2009-05-27 23:28:59Z robs $
...
<form action="<?php echo JRoute::_('index.php?option=com_users&task=completereset'); ?>" method="post" class="josForm form-validate">
