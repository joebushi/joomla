<?php
/**
* @version $Id: index2.php,v 1.2 2005/08/29 15:43:13 alekandreev Exp $
* @package Mambo
...
$groups = $acl->get_object_groups( $acl->get_object_id( 'users', $my->id, 'ARO' ), 'ARO' );

$my->gid = array_shift( $groups);
...
if ($path = $mainframe->getPath( 'admin' )) {
	...
	?>
	<img src="images/logo.png" border="0" alt="<?php echo $_LANG->_( 'Mambo Logo' ); ?>" />
	<br />
	<?php
}
