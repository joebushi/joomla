...
class FrontpageController extends JController
{
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_frontpage' );
	}
	...
	*/
	function changeState( $state = 0 )
	{
		...
		if ($total < 1) {
			...
			$this->setRedirect('index.php?option=com_frontpage', $msg, 'error');
			return;
		}
		...
		$this->setRedirect('index.php?option=com_frontpage', $msg);
	}
