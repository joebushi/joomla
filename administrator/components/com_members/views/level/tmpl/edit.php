...
window.addEvent('domready', function(){
	$('member-groups').getElements('input').each(function(i){
		...
		i.addEvent('check', function(e){
			...
			$('member-groups').getElements('input').each(function(c){
...
<form action="<?php JRoute::_('index.php?option=com_members'); ?>" method="post" name="adminForm" id="level-form">
	<fieldset style="width:45%;float:left">
		<legend><?php echo JText::_('Members_Level_Details');?></legend>
...
<?php endif; ?>
	...
	<fieldset id="member-groups">
		<legend><?php echo JText::_('Members_User_Groups_Having_Access');?></legend>
