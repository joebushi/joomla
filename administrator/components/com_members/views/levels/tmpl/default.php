...
?>
<form action="<?php echo JRoute::_('index.php?option=com_members&view=levels');?>" method="post" name="adminForm">
			...
			<ol>
				<li>
					<label for="filter_group_id">
						<?php echo JText::_('Members_Filter_Section'); ?>
					</label>
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class="left">
					<?php echo JText::_('Members_Heading_Level_Name'); ?>
				</th>
				<th width="10%">
					<?php echo JText::_('Members_Heading_Section'); ?>
				</th>
				<th width="30%">
					<?php echo JText::_('Members_Heading_Level_User_Groups'); ?>
				</th>
				<th width="30%">
					&nbsp;
				</th>
		...
		<?php
			...
			<tr class="row<?php echo $i++ % 2; ?>">
				...
				<td>
					<a href="<?php echo JRoute::_('index.php?option=com_members&task=level.edit&cid[]='.$item->id);?>">
