<?php
/**
* @version $Id: contact_category_table.class.php,v 1.1 2005/08/25 14:14:28 johanjanssens Exp $
* @package Mambo
* @subpackage Menus
...
class contact_category_table_menu {
	...
	*/
	function editCategory( $uid, $menutype, $option ) {
		...
		$lists['componentid']	= mosComponentFactory::buildCategoryList( 'componentid', 'com_contact_details', intval( $menu->componentid ), NULL, 'ordering', 5, 0 ); 
		if ( $uid ) {
			$query = "SELECT name"
			. "\n FROM #__categories"
