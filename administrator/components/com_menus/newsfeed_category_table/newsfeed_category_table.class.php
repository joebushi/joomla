<?php
/**
* @version $Id: newsfeed_category_table.class.php,v 1.1 2005/08/25 14:14:33 johanjanssens Exp $
* @package Mambo
* @subpackage Menus
...
class newsfeed_category_table_menu {
	...
	*/
	function editCategory( $uid, $menutype, $option ) {
		...
		$lists['componentid']	= mosComponentFactory::buildCategoryList( 'componentid', 'com_newsfeeds', intval( $menu->componentid ), NULL, 'name', 10, 0 ); 
		if ( $uid ) {
			$query = "SELECT name"
			. "\n FROM #__categories"
