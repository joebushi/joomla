<?php
/**
* @version $Id: admin.sections.php,v 1.2 2005/08/29 15:52:19 alekandreev Exp $
* @package Mambo
* @subpackage Sections
...
function showSections( $scope, $option ) {
	...
	. "\n WHERE c.scope = '$scope' AND a.active = 1"
	. $filter
	. "\n GROUP BY c.id"
	. $order
	;
...
function copySectionSelect( $option, $cid, $section ) {
	...
	. "\n FROM #__content AS a"
	. "\n WHERE a.sectionid IN ( $cids ) AND a.active = 1"
