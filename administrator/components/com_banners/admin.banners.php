...
function saveBanner( $task ) {
	...
	mosRedirect( 'administrator/index2.php?option=com_banners', $msg );
}
...
function cancelEditBanner() {
	...
	mosRedirect( 'administrator/index2.php?option=com_banners' );
}
...
function editBannerClient( $clientid, $option ) {
	...
	if ($row->checked_out && $row->checked_out <> $my->id) {
		...
		mosRedirect( 'administrator/index2.php?option='. $option .'&task=listclients', $msg );
	}
...
function saveBannerClient( $option ) {
	...
	if (!$row->check()) {
		mosRedirect( "administrator/index2.php?option=$option&task=editclient&cid[]=$row->id", $row->getError() );
	}
	...
	mosRedirect( "administrator/index2.php?option=$option&task=listclients" );
}
