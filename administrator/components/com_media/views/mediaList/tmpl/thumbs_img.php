			...
			<div class="imgTotal">
				<div align="center" class="imgBorder">
					<a class="img-preview" href="<?php echo $this->baseURL.'/images/'.$this->_tmp_img->path_relative; ?>" title="<?php echo $this->_tmp_img->name; ?>" style="display: block; width: 100%; height: 100%">
						<div class="image">
							<img src="<?php echo $this->baseURL.'/images/'.$this->_tmp_img->path_relative; ?>" width="<?php echo $this->_tmp_img->width; ?>" height="<?php echo $this->_tmp_img->height; ?>" alt="<?php echo $this->_tmp_img->name; ?> - <?php echo $this->_tmp_img->size; ?>" border="0" />
						</div>
					</a>
				</div>
			</div>
