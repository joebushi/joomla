<?php defined('_JEXEC') or die; ?>
		<tr>
			...
			<td class="description">
				<a href="<?php echo JRoute::_(COM_MEDIA_BASEURL.'/'.$this->_tmp_img->path_relative); ?>" title="<?php echo $this->_tmp_img->name; ?>" rel="preview"><?php echo $this->escape($this->_tmp_img->name); ?></a>
			</td>
			<td>
