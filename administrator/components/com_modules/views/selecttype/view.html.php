<?php
/**
 * @version		$Id: view.html.php 12276M 2009-09-12 10:23:46Z (local) $
...
class ModulesViewSelecttype extends JView
{
	...
	{
		JToolBarHelper::title(JText::_('Module_Add'), 'module.png');
		JToolBarHelper::customX('module.edit', 'forward.png', 'forward_f2.png', 'Next', true);
