<?php
/**
 * @version		$Id: default_item.php 12344 2009-06-24 11:28:31Z eddieajau $
...
<tr class="<?php echo "row".$this->item->index % 2; ?>" <?php echo $this->item->style; ?>>
	...
	<td>
		<input type="checkbox" id="cb<?php echo $this->item->index;?>" name="eid[<?php echo $this->item->id; ?>]" value="<?php echo $this->item->index; ?>" onclick="isChecked(this.checked);" <?php echo $this->item->cbd; ?> />
