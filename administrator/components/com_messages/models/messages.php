...
class MessagesModelMessages extends JModel
{
	...
	function __construct()
	{
		...
		JPluginHelper::importPlugin('messages');

		$adapters = JMessageHelper::getInstance();
		$this->_adapters = $adapters->getMessageAdapters();
	...
	function getData()
	{
		...
		{
			$this->_data = array();
			$this->_loadedAdapters = array();
			foreach($this->_adapters as $adapter)
			{
				$name = 'JMessage'.$adapter;
				$tempadapter = new $$name();
				$this->_data = array_merge($this->_data, $tempadapter->getMessages('date'));
				$this->_loadedAdapters[] = $tempadapter;
			}
