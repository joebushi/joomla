...
function save( $option, $task ) {
	...
	switch ( $task ) {
		...
		default:
			...
			mosRedirect( 'administrator/index2.php?option='. $option .'&task=edit&hidemainmenu=1&id='. $row->id, $msg );
			break;
	}
}
...
function changeState( $cid=null, $state=0, $option ) {
	...
	mosRedirect( 'administrator/index2.php?option='. $option .'&msg='. $msg );
}
...
function menuLink( $option, $id ) {
	...
	mosRedirect( 'administrator/index2.php?option='. $option .'&task=edit&hidemainmenu=1&id='. $id, $msg );
}
...
function saveOrder( &$cid ) {
	...
	mosRedirect( 'administrator/index2.php?option=com_typedcontent', $msg );
} // saveOrder
?>