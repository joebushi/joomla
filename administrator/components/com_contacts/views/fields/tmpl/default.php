...
<?php
	...
	JToolBarHelper::title( JText::_( 'Field Manager' ), 'generic.png' );
...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th width="10%" class="type">
				<?php echo JHTML::_('grid.sort', 'Type', 'f.type', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th width="5%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort',  'Published', 'f.published', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th width="8%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort',  'Order', 'f.ordering', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				<?php echo JHTML::_('grid.order',  $this->items ); ?>
			</th>
			<th width="10%">
				<?php echo JHTML::_('grid.sort',  'Position', 'f.pos', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th width="10%">
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
		...
		$link 		= JRoute::_( 'index.php?option=com_contacts&controller=field&view=field&task=edit&cid[]='. $row->id );
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				...
				?>
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit fields' );?>::<?php echo $row->title; ?>">
