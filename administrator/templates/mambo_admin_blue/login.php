<?php
/**
* @version $Id: login.php,v 1.1 2005/08/25 14:18:07 johanjanssens Exp $
* @package Mambo
...
<div id="wrapper">
	<div id="header">
	   <div id="mambo">
		   <img src="templates/mambo_admin_blue/images/header_text.png" alt="<?php echo $_LANG->_( 'Mambo Logo' ); ?>" />
	   </div>
	</div>
</div>
