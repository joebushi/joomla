...
$mainKeys 			= modRelatedItemsHelper::$mainArticleKeywords; // get keyword array for main article
$mainArticleAlias 	= modRelatedItemsHelper::$mainArticleAlias; // alias value for main article
$mainArticleAuthor 	= modRelatedItemsHelper::$mainArticleAuthor; // author id of main article
$mainArticleCategory = modRelatedItemsHelper::$mainArticleCategory; // category id of main article
